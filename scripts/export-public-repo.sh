...
copy_dir "docs/public-api"
copy_dir "docs/example-datasets"
copy_dir "docs/reproducibility"
copy_dir "docs/reproducible-artifacts"
copy_dir "docs/source-code"
copy_dir "docs/release-notes"
copy_dir "docs/results"
copy_file "docs/public-claims.md"
copy_file "docs/public-release-inventory.md"
copy_file "docs/release-checklist.md"
copy_file "docs/release-status.md"
copy_file "docs/dependency-audit.md"
